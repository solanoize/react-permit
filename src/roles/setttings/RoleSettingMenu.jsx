...
const RoleSettingMenu = () => {
  ...
  return (
    <ManagerWidgetRBAC context={context} permissions={[READ_ROLES, CREATE_ROLES]} or={true}>
      <NavDropdown title="Role Management">
        ...
        <ManagerWidgetRBAC context={context} permissions={[CREATE_ROLES, READ_PERMISSIONS]}>
          <NavDropdown.Item href="#roles/new">
            New Role
          </NavDropdown.Item>
        </ManagerWidgetRBAC>
      </NavDropdown>
